...
func (s *PostgresUserStore) GetByID(ctx context.Context, userID int) (User, error) {
	var user User
	var createdAt time.Time
...
func (s *PostgresUserStore) Update(ctx context.Context, userID int, params UpdateUserParams) (User, error) {
...
func (s *PostgresUserStore) ListSkills(ctx context.Context, userID int) ([]Skill, error) {
...
func (s *PostgresUserStore) ReplaceSkills(ctx context.Context, userID int, skills []Skill) error {
	tx, err := s.db.BeginTx(ctx, nil)
	if err != nil {
...
func (s *PostgresUserStore) Exists(ctx context.Context, userID int) (bool, error) {
	var exists bool
...
func (s *PostgresUserStore) HasSkill(ctx context.Context, userID int, name string) (bool, error) {
	var exists bool
